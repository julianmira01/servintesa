...
/**
  * Direccion Data Access Object (DAO) migrado a firebird 2.5.
...
public class DireccionDao {
     ...
     */
    public Direccion getObject(Connection conn, int ID_SUCURSAL) throws NotFoundException, SQLException {
    ...
    public synchronized void create(Connection conn, Direccion valueObject) throws SQLException {
          ...
          try {
               ...
               stmt.setInt(1, valueObject.getID_SUCURSAL()); 
               stmt.setString(2, valueObject.getNRODIRECCION()); 
               ...
               stmt.setString(9, valueObject.getID_PERSONA()); 
               stmt.setString(10, valueObject.getID_EMPRESA()); 
               stmt.setString(11, valueObject.getID_CIUDAD()); 
            ...
            if (Funciones.esFecha(valueObject.getFECHARES()))
               ...
               stmt.setString(14, valueObject.getIDTIPO()); 
    ...
    public void save(Connection conn, Direccion valueObject) 
          ...
          String sql = "UPDATE SUCURSAL SET NRODIRECCION = ?, DIRECCION = ?, TELEFONO1 = ?, "
               ...
               + "DIRPRINCIPAL = ? WHERE (ID_SUCURSAL = ? ) ";
          PreparedStatement stmt = null;

          try {
              stmt = conn.prepareStatement(sql);
              stmt.setString(1, valueObject.getNRODIRECCION()); 
              ...
              stmt.setString(8, valueObject.getID_PERSONA()); 
              stmt.setString(9, valueObject.getID_EMPRESA()); 
              stmt.setString(10, valueObject.getID_CIUDAD()); 
            ...
            if (Funciones.esFecha(valueObject.getFECHARES()))
             ...
             stmt.setNull(11, Types.DATE);
              ...
              stmt.setString(13, valueObject.getIDTIPO()); 
              ...
              stmt.setInt(17, valueObject.getID_SUCURSAL()); 
    ...
    public List searchMatching(Connection conn, Direccion valueObject) throws SQLException {
          ...
          if (valueObject.getNRODIRECCION() != null) {
              if (first) { first = false; }
              sql.append("AND NRODIRECCION LIKE '").append(valueObject.getNRODIRECCION()).append("%' ");
          }
          ...
          if (valueObject.getID_PERSONA() != null) {
              if (first) { first = false; }
              sql.append("AND ID_PERSONA LIKE '").append(valueObject.getID_PERSONA()).append("%' ");
          }

          if (valueObject.getID_EMPRESA() != null) {
              if (first) { first = false; }
              sql.append("AND ID_EMPRESA LIKE '").append(valueObject.getID_EMPRESA()).append("%' ");
          }

          if (valueObject.getID_CIUDAD() != null) {
              if (first) { first = false; }
              sql.append("AND ID_CIUDAD LIKE '").append(valueObject.getID_CIUDAD()).append("%' ");
          }

          if (valueObject.getFECHARES() != null) {
              if (first) { first = false; }
              sql.append("AND FECHARES LIKE '").append(valueObject.getFECHARES()).append("%' ");
          }
          ...
          if (valueObject.getIDTIPO() != null) {
              if (first) { first = false; }
              sql.append("AND IDTIPO LIKE '").append(valueObject.getIDTIPO()).append("%' ");
          }
    ...
    protected void singleQuery(Connection conn, PreparedStatement stmt, Direccion valueObject) 
          ...
          try {
              ...
              if (result.next()) {
                   ...
                   valueObject.setNRODIRECCION(result.getString("NRODIRECCION")); 
                   ...
                   valueObject.setID_PERSONA(result.getString("ID_PERSONA")); 
                   valueObject.setID_EMPRESA(result.getString("ID_EMPRESA")); 
                   valueObject.setID_CIUDAD(result.getString("ID_CIUDAD")); 
                   valueObject.setFECHARES(result.getString("FECHARES")); 
                   valueObject.setEMAIL(result.getString("EMAIL")); 
                   valueObject.setIDTIPO(result.getString("IDTIPO")); 
    ...
    protected List listQuery(Connection conn, PreparedStatement stmt) throws SQLException {
          ...
          try {
              ...
              while (result.next()) {
                   ...
                   temp.setNRODIRECCION(result.getString("NRODIRECCION")); 
                   ...
                   temp.setID_PERSONA(result.getString("ID_PERSONA")); 
                   temp.setID_EMPRESA(result.getString("ID_EMPRESA")); 
                   temp.setID_CIUDAD(result.getString("ID_CIUDAD")); 
                   temp.setFECHARES(result.getString("FECHARES")); 
                   temp.setEMAIL(result.getString("EMAIL")); 
                   temp.setIDTIPO(result.getString("IDTIPO")); 
