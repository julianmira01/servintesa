...
/**
  * EmpresasdeServicio Data Access Object (DAO) migrado a firebird 2.5.
  * This class contains all database handling that is needed to
  * permanently store and retrieve EmpresasdeServicio object instances.
  */
...
public class EmpresasdeServicioTransDao {
     ...
     * clone() method in it!
     */
    public EmpresasdeServicioTrans createValueObject() {
          return new EmpresasdeServicioTrans();
    }
     ...
     */
    public EmpresasdeServicioTrans getObject(Connection conn, int ID_EMPSERVICIO) throws NotFoundException, SQLException {

          EmpresasdeServicioTrans valueObject = createValueObject();
     ...
     */
    public void load(Connection conn, EmpresasdeServicioTrans valueObject) throws NotFoundException, SQLException {
     ...
     */
    public synchronized void create(Connection conn, EmpresasdeServicioTrans valueObject) throws SQLException {
          ...
          try {
               ...
               if(Funciones.contarCadena(valueObject.getSIGLA(), 20))
                   stmt.setString(3, valueObject.getSIGLA());
               else
                   stmt.setNull(3, Types.VARCHAR);
 
               if(Funciones.contarCadena(valueObject.getDIRECCION(), 15))
               ...
               if(valueObject.getDIGVERIF() < -1)
                   stmt.setNull(8, valueObject.getDIGVERIF());
               else if (!Funciones.EnteroesNulo(valueObject.getDIGVERIF())) 
                   stmt.setInt(8, valueObject.getDIGVERIF()); 
               else
                   stmt.setNull(8, Types.INTEGER);  
              
               if(valueObject.getES_CUPOSTOTAL()==0)
                   stmt.setNull(9, valueObject.getES_CUPOSTOTAL());
               else if (!Funciones.EnteroesNulo(valueObject.getES_CUPOSTOTAL())) 
                   stmt.setInt(9, valueObject.getES_CUPOSTOTAL()); 
               else
                   stmt.setNull(9, Types.INTEGER); 

               if(valueObject.getES_CUPOSDISP()==0)
                   stmt.setNull(10, valueObject.getES_CUPOSDISP());
               else if (!Funciones.EnteroesNulo(valueObject.getES_CUPOSDISP())) 
                   stmt.setInt(10, valueObject.getES_CUPOSDISP()); 
               else
                   stmt.setNull(10, Types.INTEGER); 
 
               if(valueObject.getTOTALCUPOBUSMICRO()==0)
                   stmt.setNull(11, valueObject.getTOTALCUPOBUSMICRO());
               else if (!Funciones.EnteroesNulo(valueObject.getTOTALCUPOBUSMICRO())) 
                   stmt.setInt(11, valueObject.getTOTALCUPOBUSMICRO()); 
               else
                   stmt.setNull(11, Types.INTEGER); 
              
               if(Funciones.contarCadena(valueObject.getID_DOCTO_RUNT(), 2))
     ...
     *                     Primary-key field must be set for this to work properly.
     */
    public void save(Connection conn, EmpresasdeServicioTrans valueObject) 
          ...
          try {
              ...
              if(valueObject.getDIGVERIF() < -1)
                  stmt.setNull(7, valueObject.getDIGVERIF());
              else if (!Funciones.EnteroesNulo(valueObject.getDIGVERIF())) 
              ...
              if(valueObject.getES_CUPOSTOTAL()==0)
                  stmt.setNull(8, valueObject.getES_CUPOSTOTAL());
              else if (!Funciones.EnteroesNulo(valueObject.getES_CUPOSTOTAL())) 
              ...
              if(valueObject.getES_CUPOSDISP()==0)
                  stmt.setNull(9, valueObject.getES_CUPOSDISP());
              else if (!Funciones.EnteroesNulo(valueObject.getES_CUPOSDISP())) 
              ...
              if(valueObject.getTOTALCUPOBUSMICRO()==0)
                  stmt.setNull(10, valueObject.getTOTALCUPOBUSMICRO());
              else if (!Funciones.EnteroesNulo(valueObject.getTOTALCUPOBUSMICRO())) 
     ...
     *                     Primary-key field must be set for this to work properly.
     */
    public void delete(Connection conn, EmpresasdeServicioTrans valueObject) 
          throws NotFoundException, SQLException {
     ...
     */
    public List searchMatching(Connection conn, EmpresasdeServicioTrans valueObject) throws SQLException {
          ...
          if (valueObject.getDIGVERIF() >= -1) { //Se usa para no tener en cuenta en caso de que no se requiera en la busqueda (ej -2) transporte Publico
              if (first) { first = false; }
          ...
          if (valueObject.getID_DOCTO_RUNT() != null) {
              if (first) { first = false; }
              sql.append("AND ID_DOCTO_RUNT = '").append(valueObject.getID_DOCTO_RUNT()).append("' ");
          }

          sql.append("ORDER BY ID_EMPSERVICIO ASC ");
            
          System.out.println("SQL search Empresas de Servicio: " + sql);
     ...
     */
    protected void singleQuery(Connection conn, PreparedStatement stmt, EmpresasdeServicioTrans valueObject) 
          throws NotFoundException, SQLException {
          ...
          try {
              ...
              if (result.next()) {
                   ...
                   valueObject.setID_DOCTO_RUNT(result.getString("ID_DOCTO_RUNT")); 
                    ...
                    //System.out.println("EmpresasdeServicio Object Not Found!");
                    throw new NotFoundException("EmpresasdeServicio Object Not Found!");
              }
          } finally {
              if (result != null)
                  result.close();
    ...
    protected List listQuery(Connection conn, PreparedStatement stmt) throws SQLException {
          ...
          try {
              ...
              while (result.next()) {
                   EmpresasdeServicioTrans temp = createValueObject();
    ...
    public int getMaxId(Connection conn) throws SQLException {
          ...
          String sql = "SELECT GEN_ID(GEN_EMPSERVICIOS,1) FROM TRANSITO";
          PreparedStatement stmt = null;
          ResultSet result = null;
          int allRows = 0;
          try {
