...
public class VehiculoNovedadDao {
     ...
     * clone() method in it!
     */
    public VehiculoNovedad createValueObject() {
          return new VehiculoNovedad();
    }
     ...
     */
    public VehiculoNovedad getObject(Connection conn, int ID_VEHICULONOV) throws NotFoundException, SQLException {

          VehiculoNovedad valueObject = createValueObject();
          valueObject.setID_VEHICULONOV(ID_VEHICULONOV);
     ...
     */
    public void load(Connection conn, VehiculoNovedad valueObject) throws NotFoundException, SQLException {

          String sql = "SELECT * FROM VEHICULONOVEDAD WHERE (ID_VEHICULONOV = ? ) "; 
          PreparedStatement stmt = null;

          try {
               stmt = conn.prepareStatement(sql);
               stmt.setInt(1, valueObject.getID_VEHICULONOV()); 
    ...
    public List loadAll(Connection conn) throws SQLException {
          ...
          String sql = "SELECT * FROM VEHICULONOVEDAD ORDER BY ID_VEHICULONOV ASC ";
     ...
     */
    public synchronized void create(Connection conn, Vehiculo valueObject, int id) throws SQLException {
         ...
         try {
               sql = "INSERT INTO VEHICULONOVEDAD ( ID_VEHICULO, PLACA, SERIE_MOTOR, "
               ...
               + "VIN, ID_ORGTRANSITOORIGEN, AUTORIZATRASLADO,  VEHPLANORUNT, ID_VEHICULONOV) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?) ";
     ...
     *                     Primary-key field must be set for this to work properly.
     */
    public void save(Connection conn, VehiculoNovedad valueObject) 
          throws NotFoundException, SQLException {

          String sql = "UPDATE VEHICULONOVEDAD SET PLACA = ?, SERIE_MOTOR = ?, CILINDRAJE = ?, "
               ...
               + "IDLOGIN_CANCELA = ?, FECHA_SISTEMA_CANCELA = ?, TIPOCANCELA = ?, "
               + "RECUPERAMOTOR = ?, PORCENTAJEREPOSICION = ?, VIN = ?, "
               + "ID_ORGTRANSITOORIGEN = ?, AUTORIZATRASLADO = ?, VEHPLANORUNT = ?, ID_VEHICULO = ? WHERE (ID_VEHICULONOV = ? ) ";
          PreparedStatement stmt = null;
          ...
          try {
            ...
            if (Funciones.esFecha(valueObject.getFECHAREG()))
              ...
              stmt.setString(24, valueObject.getID_EMPSERVIPUBLICO()); 
              stmt.setString(25, valueObject.getID_MARCA()); 
              stmt.setString(26, valueObject.getID_LINEA()); 
            ...
            if (Funciones.esFecha(valueObject.getFECHA_SISTEMA_CANCELA()))
              stmt.setDate(116, Funciones.convFechaSSQL(valueObject.getFECHA_SISTEMA_CANCELA()));
            else
              stmt.setNull(116, Types.DATE);
              ...
              stmt.setString(122, valueObject.getAUTORIZATRASLADO()); 
              stmt.setString(123, valueObject.getVEHPLANORUNT());
              stmt.setInt(124, valueObject.getID_VEHICULO()); 
              
              stmt.setInt(125,valueObject.getID_VEHICULONOV());
     ...
     *                     Primary-key field must be set for this to work properly.
     */
    public void delete(Connection conn, VehiculoNovedad valueObject) 
          throws NotFoundException, SQLException {

          String sql = "DELETE FROM VEHICULONOVEDAD WHERE (ID_VEHICULONOV = ? ) ";
          PreparedStatement stmt = null;
    ...
    public void deleteAll(Connection conn) throws SQLException {
          ...
          String sql = "DELETE FROM VEHICULONOVEDAD";
          PreparedStatement stmt = null;
    ...
    public int countAll(Connection conn) throws SQLException {
          ...
          String sql = "SELECT count(*) FROM VEHICULONOVEDAD";
          PreparedStatement stmt = null;
          ResultSet result = null;
          int allRows = 0;
     ...
     */
    public List searchMatching(Connection conn, VehiculoNovedad valueObject) throws SQLException {

          List searchResults;

          boolean first = true;
          StringBuffer sql = new StringBuffer("SELECT * FROM VEHICULONOVEDAD WHERE 1=1 ");

      if (valueObject.getID_VEHICULONOV() != 0) {
          if (first) { first = false; }
          sql.append("AND ID_VEHICULONOV = ").append(valueObject.getID_VEHICULONOV()).append(" ");
      }
     ...
     */
    protected void singleQuery(Connection conn, PreparedStatement stmt, VehiculoNovedad valueObject) 
          throws NotFoundException, SQLException {
          ...
          try {
              ...
              if (result.next()) {
                   ...
                   valueObject.setID_VEHICULONOV(result.getInt("ID_VEHICULONOV"));
    ...
    protected List listQuery(Connection conn, PreparedStatement stmt) throws SQLException {
          ...
          try {
              ...
              while (result.next()) {
                   VehiculoNovedad temp = createValueObject();

                   temp.setID_VEHICULONOV(result.getInt("ID_VEHICULONOV"));
