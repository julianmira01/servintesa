...
/**
  * ViewPagosFaltantesCarga Data Access Object (DAO) migrado a firebird 2.5.
  * This class contains all database handling that is needed to
  * permanently store and retrieve ViewPagosFaltantesCarga object instances.
  */
...
public class ViewPagosFaltantesCargaDao {
     ...
     * clone() method in it!
     */
    public ViewPagosFaltantesCarga createValueObject() {
          return new ViewPagosFaltantesCarga();
    }
     ...
     */
    public ViewPagosFaltantesCarga getObject(Connection conn, int ID) throws NotFoundException, SQLException {

          ViewPagosFaltantesCarga valueObject = createValueObject();
     ...
     */
    public void load(Connection conn, ViewPagosFaltantesCarga valueObject) throws NotFoundException, SQLException {

          String sql = "SELECT * FROM VIEW_PAGOS_FALTANTES_CARGA WHERE (ID = ? ) "; 
    ...
    public List loadAll(Connection conn) throws SQLException {
          ...
          String sql = "SELECT * FROM VIEW_PAGOS_FALTANTES_CARGA ORDER BY ID ASC ";
     ...
     */
    public synchronized void create(Connection conn, ViewPagosFaltantesCarga valueObject) throws SQLException {
          ...
          try {
               sql = "INSERT INTO VIEW_PAGOS_FALTANTES_CARGA ( ID, VALOR, NUMEROCOMPARENDO, "
               + "POLCA, NROIDENTIFICACION, IDLIQUIDACION, "
               + "FECHAPAGO, NUMERO_RECIBO, NROCONSIGNACIONBANCO, "
               + "HORAREGISTRO, VALORFORMAPAGO, ID_TIPOPAGO, "
               + "DESCRIPCION) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?) ";
               stmt = conn.prepareStatement(sql);
               ...
               //stmt.setString(10, valueObject.getHORAREGISTRO()); 
            if (Funciones.esTime(valueObject.getHORAREGISTRO()))
                stmt.setTime(10, Funciones.calendarToTime(Funciones.stringToCalendar(valueObject.getHORAREGISTRO())));
            else
                stmt.setNull(10, Types.TIME);
               
               stmt.setDouble(11, valueObject.getVALORFORMAPAGO()); 
               stmt.setInt(12, valueObject.getID_TIPOPAGO()); 
               stmt.setString(13, valueObject.getDESCRIPCION()); 
     ...
     *                     Primary-key field must be set for this to work properly.
     */
    public void save(Connection conn, ViewPagosFaltantesCarga valueObject) 
          throws NotFoundException, SQLException {

          String sql = "UPDATE VIEW_PAGOS_FALTANTES_CARGA SET VALOR = ?, NUMEROCOMPARENDO = ?, POLCA = ?, "
               + "NROIDENTIFICACION = ?, IDLIQUIDACION = ?, FECHAPAGO = ?, "
               + "NUMERO_RECIBO = ?, NROCONSIGNACIONBANCO = ?, HORAREGISTRO = ?, "
               + "VALORFORMAPAGO = ?, ID_TIPOPAGO = ?, DESCRIPCION = ? WHERE (ID = ? ) ";
          PreparedStatement stmt = null;

          try {
              stmt = conn.prepareStatement(sql);
              stmt.setDouble(1, valueObject.getVALOR()); 
              ...
              //stmt.setString(9, valueObject.getHORAREGISTRO());               
            if (Funciones.esTime(valueObject.getHORAREGISTRO()))
                stmt.setTime(9, Funciones.calendarToTime(Funciones.stringToCalendar(valueObject.getHORAREGISTRO())));
            else
                stmt.setNull(9, Types.TIME);
              
              stmt.setDouble(10, valueObject.getVALORFORMAPAGO()); 
              stmt.setInt(11, valueObject.getID_TIPOPAGO()); 
              stmt.setString(12, valueObject.getDESCRIPCION()); 

              stmt.setInt(13, valueObject.getID()); 
     ...
     *                     Primary-key field must be set for this to work properly.
     */
    public void delete(Connection conn, ViewPagosFaltantesCarga valueObject) 
          throws NotFoundException, SQLException {

          String sql = "DELETE FROM VIEW_PAGOS_FALTANTES_CARGA WHERE (ID = ? ) ";
          PreparedStatement stmt = null;
    ...
    public void deleteAll(Connection conn) throws SQLException {
          ...
          String sql = "DELETE FROM VIEW_PAGOS_FALTANTES_CARGA";
          PreparedStatement stmt = null;
    ...
    public int countAll(Connection conn) throws SQLException {
          ...
          String sql = "SELECT count(*) FROM VIEW_PAGOS_FALTANTES_CARGA";
          PreparedStatement stmt = null;
          ResultSet result = null;
          int allRows = 0;
     ...
     */
    public List searchMatching(Connection conn, ViewPagosFaltantesCarga valueObject) throws SQLException {

          List searchResults;

          boolean first = true;
          StringBuffer sql = new StringBuffer("SELECT * FROM VIEW_PAGOS_FALTANTES_CARGA WHERE 1=1 ");
          ...
          if (valueObject.getVALORFORMAPAGO() != 0) {
              if (first) { first = false; }
              sql.append("AND VALORFORMAPAGO = ").append(valueObject.getVALORFORMAPAGO()).append(" ");
          }
     ...
     */
    protected void singleQuery(Connection conn, PreparedStatement stmt, ViewPagosFaltantesCarga valueObject) 
          throws NotFoundException, SQLException {
          ...
          try {
              ...
              if (result.next()) {
                   ...
                   valueObject.setVALORFORMAPAGO(result.getDouble("VALORFORMAPAGO")); 
                   valueObject.setID_TIPOPAGO(result.getInt("ID_TIPOPAGO")); 
                   valueObject.setDESCRIPCION(result.getString("DESCRIPCION")); 

              } else {
                    //System.out.println("ViewPagosFaltantesCarga Object Not Found!");
                    throw new NotFoundException("ViewPagosFaltantesCarga Object Not Found!");
              }
          } finally {
              if (result != null)
                  result.close();
    ...
    protected List listQuery(Connection conn, PreparedStatement stmt) throws SQLException {
          ...
          try {
              ...
              while (result.next()) {
                   ViewPagosFaltantesCarga temp = createValueObject();
                   ...
                   temp.setVALORFORMAPAGO(result.getDouble("VALORFORMAPAGO")); 
