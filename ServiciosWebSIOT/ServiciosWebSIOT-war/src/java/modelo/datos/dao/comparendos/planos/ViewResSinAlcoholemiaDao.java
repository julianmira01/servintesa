...
/**
  * ViewResSinAlcoholemia Data Access Object (DAO) migrado a firebird 2.5.
  * This class contains all database handling that is needed to
  * permanently store and retrieve ViewResSinAlcoholemia object instances.
  */
...
public class ViewResSinAlcoholemiaDao {
     ...
     * clone() method in it!
     */
    public ViewResSinAlcoholemia createValueObject() {
        return new ViewResSinAlcoholemia();
    }
     ...
     */
    public ViewResSinAlcoholemia getObject(Connection conn, String NUMERO) throws NotFoundException, SQLException {

        ViewResSinAlcoholemia valueObject = createValueObject();
     ...
     */
    public void load(Connection conn, ViewResSinAlcoholemia valueObject) throws NotFoundException, SQLException {
        ...
        String sql = "SELECT * FROM VIEW_RES_SINALCOHOLEMIA WHERE (NUMERO = ? ) ";
    ...
    public List loadAll(Connection conn) throws SQLException {
        ...
        String sql = "SELECT * FROM VIEW_RES_SINALCOHOLEMIA ORDER BY NUMERO ASC ";
     ...
     */
    public synchronized void create(Connection conn, ViewResSinAlcoholemia valueObject) throws SQLException {
        ...
        try {
            sql =
"INSERT INTO VIEW_RES_SINALCOHOLEMIA ( NUMERO, FECHA, CODTIPORESOLUCION, " + "NUMEROCOMPARENDO, ID_COMPARENDO, FECHACOMPARENDO, " +
  ...
  "COD_INFRACCION, NUEVO_CODIGO) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?) ";
     ...
     *                     Primary-key field must be set for this to work properly.
     */
    public void save(Connection conn, ViewResSinAlcoholemia valueObject) throws NotFoundException, SQLException {

        String sql =
            "UPDATE VIEW_RES_SINALCOHOLEMIA SET FECHA = ?, CODTIPORESOLUCION = ?, NUMEROCOMPARENDO = ?, " + "ID_COMPARENDO = ?, FECHACOMPARENDO = ?, POLCA = ?, " +
     ...
     *                     Primary-key field must be set for this to work properly.
     */
    public void delete(Connection conn, ViewResSinAlcoholemia valueObject) throws NotFoundException, SQLException {
        ...
        String sql = "DELETE FROM VIEW_RES_SINALCOHOLEMIA WHERE (NUMERO = ? ) ";
        PreparedStatement stmt = null;
    ...
    public void deleteAll(Connection conn) throws SQLException {
        ...
        String sql = "DELETE FROM VIEW_RES_SINALCOHOLEMIA";
        PreparedStatement stmt = null;
    ...
    public int countAll(Connection conn) throws SQLException {
        ...
        String sql = "SELECT count(*) FROM VIEW_RES_SINALCOHOLEMIA";
        PreparedStatement stmt = null;
        ResultSet result = null;
        int allRows = 0;
     ...
     */
    public List searchMatching(Connection conn, ViewResSinAlcoholemia valueObject) throws SQLException {

        List searchResults;

        boolean first = true;
        StringBuffer sql = new StringBuffer("SELECT * FROM VIEW_RES_SINALCOHOLEMIA WHERE 1=1 ");
    ...
    protected void singleQuery(Connection conn, PreparedStatement stmt,
                               ViewResSinAlcoholemia valueObject) throws NotFoundException, SQLException {
        ...
        try {
            ...
            if (result.next()) {
                ...
                //System.out.println("ViewResSinAlcoholemia Object Not Found!");
                throw new NotFoundException("ViewResSinAlcoholemia Object Not Found!");
            }
        } finally {
            if (result != null)
                result.close();
    ...
    protected List listQuery(Connection conn, PreparedStatement stmt) throws SQLException {
        ...
        try {
            ...
            while (result.next()) {
                ViewResSinAlcoholemia temp = createValueObject();
    ...
    public List getResolucionesSinAlcoholemiaPorFechas(Connection conn, ViewResSinAlcoholemia valueObject,
        ...
        sql.append("AND (FECHA BETWEEN '").append(Funciones.convFechaFormatoMotor(fecha2)).append("' AND '").append(Funciones.convFechaFormatoMotor(fecha2)).append("') ");
