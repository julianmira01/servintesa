...
/**
  * ViewComparendosFechas Data Access Object (DAO) migrado a firebird 2.5.
  * This class contains all database handling that is needed to
  * permanently store and retrieve ViewComparendosFechas object instances.
  */
...
public class ViewComparendosFechasDao {
     ...
     * clone() method in it!
     */
    public ViewComparendosFechas createValueObject() {
        return new ViewComparendosFechas();
    }
     ...
     */
    public ViewComparendosFechas getObject(Connection conn, String PLACA) throws NotFoundException, SQLException {

        ViewComparendosFechas valueObject = createValueObject();
     ...
     */
    public void load(Connection conn, ViewComparendosFechas valueObject) throws NotFoundException, SQLException {
        ...
        String sql = "SELECT * FROM VIEW_COMPARENDOS_FECHAS WHERE (PLACA = ? ) ";
    ...
    public List loadAll(Connection conn) throws SQLException {
        ...
        String sql = "SELECT * FROM VIEW_COMPARENDOS_FECHAS ORDER BY PLACA ASC ";
     ...
     */
    public synchronized void create(Connection conn, ViewComparendosFechas valueObject) throws SQLException {
        ...
        try {
            sql =
"INSERT INTO VIEW_COMPARENDOS_FECHAS ( PLACA, ID_INFRACTOR, ID_COMPARENDO, " + "NUMEROCOMPARENDO, FECHACOMPARENDO, HORACOMPARENDO, " +
  ...
  "DIRECCIONPATIO_INMOVILIZA, DESCRIPCIONPATIO, VALORINFRACCION, " +
  "NUEVO_CODIGO, NUEVO_CODIGOCORREGIDO, PLACAAGENTE, " + "COD_ESTADO, CODTIPOINFRACTOR, IDREPORTECOMPARENDO, " +
  "NROIDENTIFICACION, IDESTADO) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?) ";
            stmt = conn.prepareStatement(sql);
            ...
            stmt.setString(22, valueObject.getNUEVO_CODIGO());
            stmt.setString(23, valueObject.getNUEVO_CODIGOCORREGIDO());
            stmt.setString(24, valueObject.getPLACAAGENTE());
            stmt.setString(25, valueObject.getCOD_ESTADO());
            stmt.setString(26, valueObject.getCODTIPOINFRACTOR());
            stmt.setInt(27, valueObject.getIDREPORTECOMPARENDO());
            stmt.setString(28, valueObject.getNROIDENTIFICACION());
            stmt.setString(29, valueObject.getIDESTADO());
     ...
     *                     Primary-key field must be set for this to work properly.
     */
    public void save(Connection conn, ViewComparendosFechas valueObject) throws NotFoundException, SQLException {

        String sql =
            "UPDATE VIEW_COMPARENDOS_FECHAS SET ID_INFRACTOR = ?, ID_COMPARENDO = ?, NUMEROCOMPARENDO = ?, " + "FECHACOMPARENDO = ?, HORACOMPARENDO = ?, DIRECCIONINFRACCION = ?, " +
            ...
            "DESCRIPCIONPATIO = ?, VALORINFRACCION = ?, NUEVO_CODIGO = ?, " +
            "NUEVO_CODIGOCORREGIDO = ?, PLACAAGENTE = ?, COD_ESTADO = ?, " +
            "CODTIPOINFRACTOR = ?, IDREPORTECOMPARENDO = ?, NROIDENTIFICACION = ?, " +
            "IDESTADO = ? WHERE (PLACA = ? ) ";
        PreparedStatement stmt = null;
        ...
        try {
          ...
          if (Funciones.esTime(valueObject.getHORACOMPARENDO()))
            ...
            stmt.setString(21, valueObject.getNUEVO_CODIGO());
            stmt.setString(22, valueObject.getNUEVO_CODIGOCORREGIDO());
            stmt.setString(23, valueObject.getPLACAAGENTE());
            stmt.setString(24, valueObject.getCOD_ESTADO());
            stmt.setString(25, valueObject.getCODTIPOINFRACTOR());
            stmt.setInt(26, valueObject.getIDREPORTECOMPARENDO());
            stmt.setString(27, valueObject.getNROIDENTIFICACION());
            stmt.setString(28, valueObject.getIDESTADO());

            stmt.setString(29, valueObject.getPLACA());
     ...
     *                     Primary-key field must be set for this to work properly.
     */
    public void delete(Connection conn, ViewComparendosFechas valueObject) throws NotFoundException, SQLException {
        ...
        String sql = "DELETE FROM VIEW_COMPARENDOS_FECHAS WHERE (PLACA = ? ) ";
        PreparedStatement stmt = null;
    ...
    public void deleteAll(Connection conn) throws SQLException {
        ...
        String sql = "DELETE FROM VIEW_COMPARENDOS_FECHAS";
        PreparedStatement stmt = null;
    ...
    public int countAll(Connection conn) throws SQLException {
        ...
        String sql = "SELECT count(*) FROM VIEW_COMPARENDOS_FECHAS";
        PreparedStatement stmt = null;
        ResultSet result = null;
        int allRows = 0;
     ...
     */
    public List searchMatching(Connection conn, ViewComparendosFechas valueObject) throws SQLException {

        List searchResults;

        boolean first = true;
        StringBuffer sql = new StringBuffer("SELECT * FROM VIEW_COMPARENDOS_FECHAS WHERE 1=1 ");
    ...
    protected void singleQuery(Connection conn, PreparedStatement stmt,
                               ViewComparendosFechas valueObject) throws NotFoundException, SQLException {
        ...
        try {
            ...
            if (result.next()) {
                ...
                valueObject.setIDESTADO(result.getString("IDESTADO"));

            } else {
                //System.out.println("ViewComparendosFechas Object Not Found!");
                throw new NotFoundException("ViewComparendosFechas Object Not Found!");
            }
        } finally {
            if (result != null)
                result.close();
    ...
    protected List listQuery(Connection conn, PreparedStatement stmt) throws SQLException {
        ...
        try {
            ...
            while (result.next()) {
                ViewComparendosFechas temp = createValueObject();
                ...
                temp.setIDESTADO(result.getString("IDESTADO"));
    ...
    public List getComparendoPorRangoFechas(Connection conn, ViewComparendosFechas valueObject, String fecha1,
        ...
        sql.append("AND (IDESTADO IN (4,10,11,20,2)) ");
        sql.append("ORDER BY NUMEROCOMPARENDO, FECHACOMPARENDO ASC ");

        // Prevent accidential full table results.
        // Use loadAll if all rows must be returned.
        System.out.println("ViewComparendosFechaDao: " + sql.toString());
        searchResults = listQuery(conn, conn.prepareStatement(sql.toString()));

        return searchResults;
    }

    public List getComparendoPorRangoFechasRegistro(Connection conn, ViewComparendosFechas valueObject, String fecha1,
                                            String fecha2) throws SQLException {
        ...
        sql.append("AND (FECHAREGISTRO BETWEEN '").append(Funciones.convFechaFormatoMotor(fecha1)).append("' AND '").append(Funciones.convFechaFormatoMotor(fecha2)).append("') ");
        sql.append("AND (IDESTADO IN (4,10,11,20,2)) ");
        sql.append("ORDER BY NUMEROCOMPARENDO, FECHAREGISTRO ASC ");
    ...
    public List getComparendoNoPagosPorRangoFechas(Connection conn, ViewComparendosFechas valueObject, String fecha1,
                                                   String fecha2) throws SQLException {
        ...
        sql.append("AND (FECHACOMPARENDO BETWEEN '").append(Funciones.convFechaFormatoMotor(fecha1)).append("' AND '").append(Funciones.convFechaFormatoMotor(fecha2)).append("') ");
        sql.append("AND (IDESTADO IN (4,10,11,20)) ");
        sql.append("ORDER BY NUMEROCOMPARENDO, FECHACOMPARENDO ASC ");
    ...
    public List getComparendoNoPagosPorRangoFechasRegistro(Connection conn, ViewComparendosFechas valueObject, String fecha1,
                                                   String fecha2) throws SQLException {
