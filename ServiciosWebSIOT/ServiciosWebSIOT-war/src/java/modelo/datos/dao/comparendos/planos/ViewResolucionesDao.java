...
public class ViewResolucionesDao {
     ...
     */
    public ViewResoluciones getObject(Connection conn, String NUMERO) throws NotFoundException, SQLException {
    ...
    public void load(Connection conn, ViewResoluciones valueObject) throws NotFoundException, SQLException {
        ...
        String sql = "SELECT * FROM VIEW_RESOLUCIONES WHERE (NUMERO = ? ) ";
    ...
    public List loadAll(Connection conn) throws SQLException {
        ...
        String sql = "SELECT * FROM VIEW_RESOLUCIONES ORDER BY NUMERO ASC ";
    ...
    public synchronized void create(Connection conn, ViewResoluciones valueObject) throws SQLException {
        ...
        try {
            sql =
"INSERT INTO VIEW_RESOLUCIONES ( NUMERO, FECHA, CODTIPORESOLUCION, " + "NUMEROCOMPARENDO, ID_COMPARENDO, FECHACOMPARENDO, " +
  ...
  "COD_INFRACCION, NUEVO_CODIGO) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?) ";
     ...
     *                     Primary-key field must be set for this to work properly.
     */
    public void save(Connection conn, ViewResoluciones valueObject) throws NotFoundException, SQLException {

        String sql =
            "UPDATE VIEW_RESOLUCIONES SET FECHA = ?, CODTIPORESOLUCION = ?, NUMEROCOMPARENDO = ?, " + "ID_COMPARENDO = ?, FECHACOMPARENDO = ?, POLCA = ?, " +
     ...
     *                     Primary-key field must be set for this to work properly.
     */
    public void delete(Connection conn, ViewResoluciones valueObject) throws NotFoundException, SQLException {
        ...
        String sql = "DELETE FROM VIEW_RESOLUCIONES WHERE (NUMERO = ? ) ";
        PreparedStatement stmt = null;
    ...
    protected void singleQuery(Connection conn, PreparedStatement stmt,
                               ViewResoluciones valueObject) throws NotFoundException, SQLException {
    ...
    public List getResolucionesPorFechas(Connection conn, ViewResoluciones valueObject, String fecha1,
