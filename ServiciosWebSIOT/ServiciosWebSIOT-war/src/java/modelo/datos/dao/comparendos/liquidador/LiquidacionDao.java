...
/**
  * Liquidacion Data Access Object (DAO) migrado a firebird 2.5.
  * This class contains all database handling that is needed to
  * permanently store and retrieve Liquidacion object instances.
  */
...
public class LiquidacionDao {
     ...
     */
    public Liquidacion getObject(Connection conn, int IDLIQUIDACION) throws NotFoundException, SQLException {

          Liquidacion valueObject = createValueObject();
     ...
     */
    public void load(Connection conn, Liquidacion valueObject) throws NotFoundException, SQLException {
     ...
     */
    public synchronized void create(Connection conn, Liquidacion valueObject) throws SQLException {
          ...
          try {
               ...
               + "IDUSUARIO, ESTADOLIQ, NROCOMP, NUMERO_CERTIFICADO, FECHA_CERTIFICADO, ID_CENTRO) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?) ";
               stmt = conn.prepareStatement(sql);

               stmt.setInt(1, valueObject.getIDLIQUIDACION()); 
               stmt.setString(2, valueObject.getTOTAL()); 
            ...
            if (Funciones.esFecha(valueObject.getFECHA()))
               ...
               stmt.setString(4, valueObject.getSALDO()); 
            ...
            if (Funciones.esTime(valueObject.getHORAREGISTRO()))
               ...
               stmt.setString(7, valueObject.getIDUSUARIO()); 
     ...
     *                     Primary-key field must be set for this to work properly.
     */
    public void save(Connection conn, Liquidacion valueObject) 
          ...
          try {
              stmt = conn.prepareStatement(sql);
              stmt.setString(1, valueObject.getTOTAL()); 
            ...
            if (Funciones.esFecha(valueObject.getFECHA()))
              ...
              stmt.setString(3, valueObject.getSALDO()); 
     ...
     *                     Primary-key field must be set for this to work properly.
     */
    public void delete(Connection conn, Liquidacion valueObject) 
          throws NotFoundException, SQLException {
     ...
     */
    public List searchMatching(Connection conn, Liquidacion valueObject) throws SQLException {
          ...
          if (valueObject.getTOTAL() != null) {
              if (first) { first = false; }
              sql.append("AND TOTAL LIKE '").append(valueObject.getTOTAL()).append("%' ");
          }
          ...
          if (valueObject.getSALDO() != null) {
              if (first) { first = false; }
              sql.append("AND SALDO LIKE '").append(valueObject.getSALDO()).append("%' ");
          }
          ...
          if (valueObject.getIDUSUARIO() != null) {
              if (first) { first = false; }
              sql.append("AND IDUSUARIO LIKE '").append(valueObject.getIDUSUARIO()).append("%' ");
          }

          if (valueObject.getESTADOLIQ() != null) {
              if (first) { first = false; }
              sql.append("AND ESTADOLIQ LIKE '").append(valueObject.getESTADOLIQ()).append("%' ");
          }

          if (valueObject.getNROCOMP() != null) {
              if (first) { first = false; }
              sql.append("AND NROCOMP LIKE '").append(valueObject.getNROCOMP()).append("%' ");
          }
     ...
     */
    protected void singleQuery(Connection conn, PreparedStatement stmt, Liquidacion valueObject) 
          throws NotFoundException, SQLException {
          ...
          try {
              ...
              if (result.next()) {
                  ...
                  valueObject.setID_CENTRO(result.getInt("ID_CENTRO")); 
                    ...
                    //System.out.println("Liquidacion Object Not Found!");
                    throw new NotFoundException("Liquidacion Object Not Found!");
              }
          } finally {
              if (result != null)
                  result.close();
    ...
    protected List listQuery(Connection conn, PreparedStatement stmt) throws SQLException {
          ...
          try {
              ...
              while (result.next()) {
                   ...
                   temp.setTOTAL(result.getString("TOTAL")); 
                   temp.setFECHA(result.getString("FECHA")); 
                   temp.setSALDO(result.getString("SALDO")); 
  ...
  /* public int getMaxId(Connection conn) throws SQLException {
        ...
        String sql = "SELECT GEN_ID(GEN_IDLIQUIDACION,1) FROM TRANSITO";        
