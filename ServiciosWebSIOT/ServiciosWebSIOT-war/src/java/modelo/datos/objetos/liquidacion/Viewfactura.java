...
import java.math.*;
 ...
 /**
  * Viewfactura Value Object.
  * This class is value object representing database table VIEW_FACTURA
...
public class Viewfactura implements Cloneable, Serializable {
    ...
    private String LF_FECHA_SUP;
    private String LF_FECHA_PAGO;
    private String LF_FECHA_PAGO_SUP;
    ...
    public Viewfactura (int LF_IDIn) {
    ...
    /** 
     * hasEqualMapping-method will compare two Viewfactura instances
     * and return true if they contain same values in all persistent instance 
     * variables. If hasEqualMapping returns true, it does not mean the objects
     * are the same instance. However it does mean that in that moment, they 
     * are mapped to the same row in database.
     */
    public boolean hasEqualMapping(Viewfactura valueObject) {
    ...
    public String toString() {
        ...
        out.append("\nclass Viewfactura, mapping to table VIEW_FACTURA\n");
     ...
     */
    public Object clone() {
        Viewfactura cloned = new Viewfactura();
    ...
    public String getLF_FECHA_SUP() {
        return LF_FECHA_SUP;
    }

    public void setLF_FECHA_SUP(String LF_FECHA_SUP) {
        this.LF_FECHA_SUP = LF_FECHA_SUP;
    }

    public String getLF_FECHA_PAGO_SUP() {
        return LF_FECHA_PAGO_SUP;
    }

    public void setLF_FECHA_PAGO_SUP(String LF_FECHA_PAGO_SUP) {
        this.LF_FECHA_PAGO_SUP = LF_FECHA_PAGO_SUP;
    }
}
