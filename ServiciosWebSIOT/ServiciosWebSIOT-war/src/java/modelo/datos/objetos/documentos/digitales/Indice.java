...
import java.math.*;
 ...
 /**
  * Indice Value Object.
  * This class is value object representing database table Indice
...
public class Indice implements Cloneable, Serializable {
    ...
    /** 
     * hasEqualMapping-method will compare two Indice instances
     * and return true if they contain same values in all persistent instance 
     * variables. If hasEqualMapping returns true, it does not mean the objects
     * are the same instance. However it does mean that in that moment, they 
     * are mapped to the same row in database.
     */
    public boolean hasEqualMapping(Indice valueObject) {
    ...
    public String toString() {
        ...
        out.append("\nclass Indice, mapping to table Indice\n");
