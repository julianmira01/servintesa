...
import java.math.*;
 ...
 /**
  * ElementoTipoDocumento Value Object.
  * This class is value object representing database table ElementoTipoDocumento
...
public class ElementoTipoDocumento implements Cloneable, Serializable {
    ...
    public ElementoTipoDocumento () {

    }

    public ElementoTipoDocumento (int ID_ELEMENTO_TIPODOCUMENTOIn) {
    ...
    /** 
     * hasEqualMapping-method will compare two ElementoTipoDocumento instances
     * and return true if they contain same values in all persistent instance 
     * variables. If hasEqualMapping returns true, it does not mean the objects
     * are the same instance. However it does mean that in that moment, they 
     * are mapped to the same row in database.
     */
    public boolean hasEqualMapping(ElementoTipoDocumento valueObject) {
    ...
    public String toString() {
        ...
        out.append("\nclass ElementoTipoDocumento, mapping to table ElementoTipoDocumento\n");
     ...
     */
    public Object clone() {
        ElementoTipoDocumento cloned = new ElementoTipoDocumento();
