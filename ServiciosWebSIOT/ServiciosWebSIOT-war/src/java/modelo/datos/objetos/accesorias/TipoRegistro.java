...
import java.math.*;
 ...
 /**
  * TipoRegistro Value Object.
  * This class is value object representing database table TIPO_REGISTRO
...
public class TipoRegistro implements Cloneable, Serializable {
    ...
    public TipoRegistro (int ID_TIPO_REGISTROIn) {
    ...
    public void setAll(int ID_TIPO_REGISTROIn,
    ...
    /** 
     * hasEqualMapping-method will compare two TipoRegistro instances
     * and return true if they contain same values in all persistent instance 
     * variables. If hasEqualMapping returns true, it does not mean the objects
     * are the same instance. However it does mean that in that moment, they 
     * are mapped to the same row in database.
     */
    public boolean hasEqualMapping(TipoRegistro valueObject) {
    ...
    public String toString() {
        ...
        out.append("\nclass TipoRegistro, mapping to table TIPO_REGISTRO\n");
     ...
     */
    public Object clone() {
        TipoRegistro cloned = new TipoRegistro();
