...
import java.math.*;
  ...
  */
public class Documento implements Cloneable, Serializable {
    ...
    public Documento (String ID_DOCTOIn) {
     ...
     */
    public boolean hasEqualMapping(Documento valueObject) {
     ...
     */
    public Object clone() {
        Documento cloned = new Documento();
