...
import java.math.*;
 ...
 /**
  * RuntMotivoRegrabacion Value Object.
  * This class is value object representing database table RUNTMOTIVOREGRABACION
...
public class RuntMotivoRegrabacion implements Cloneable, Serializable {
    ...
    public RuntMotivoRegrabacion () {

    }

    public RuntMotivoRegrabacion (String CODIGOIn) {
    ...
    /** 
     * hasEqualMapping-method will compare two RuntMotivoRegrabacion instances
     * and return true if they contain same values in all persistent instance 
     * variables. If hasEqualMapping returns true, it does not mean the objects
     * are the same instance. However it does mean that in that moment, they 
     * are mapped to the same row in database.
     */
    public boolean hasEqualMapping(RuntMotivoRegrabacion valueObject) {
    ...
    public String toString() {
        ...
        out.append("\nclass RuntMotivoRegrabacion, mapping to table RUNTMOTIVOREGRABACION\n");
     ...
     */
    public Object clone() {
        RuntMotivoRegrabacion cloned = new RuntMotivoRegrabacion();
