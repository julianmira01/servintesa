...
import java.math.*;
 ...
 /**
  * EstadosFactura Value Object.
  * This class is value object representing database table EstadosFactura
...
public class EstadosFactura implements Cloneable, Serializable {
    ...
    public EstadosFactura (int ID_ESTADOIn) {
    ...
    public void setAll(int ID_ESTADOIn,
          int VALORIn,
    ...
    /** 
     * hasEqualMapping-method will compare two EstadosFactura instances
     * and return true if they contain same values in all persistent instance 
     * variables. If hasEqualMapping returns true, it does not mean the objects
     * are the same instance. However it does mean that in that moment, they 
     * are mapped to the same row in database.
     */
    public boolean hasEqualMapping(EstadosFactura valueObject) {
    ...
    public String toString() {
        ...
        out.append("\nclass EstadosFactura, mapping to table EstadosFactura\n");
     ...
     */
    public Object clone() {
        EstadosFactura cloned = new EstadosFactura();
