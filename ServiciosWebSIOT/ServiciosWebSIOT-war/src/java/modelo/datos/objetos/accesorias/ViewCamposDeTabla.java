...
import java.math.*;
 ...
 /**
  * ViewCamposDeTabla Value Object.
  * This class is value object representing database table VIEW_CAMPOSDETABLA
...
public class ViewCamposDeTabla implements Cloneable, Serializable {
    ...
    public ViewCamposDeTabla () {

    }

    public ViewCamposDeTabla (String NOMBREIn) {
    ...
    public void setAll(String NOMBREIn,
          int ID_TABLAIn,
          int VISIBLEIn,
          String LABELIn,
          String TIPODATOIn,
    ...
    /** 
     * hasEqualMapping-method will compare two ViewCamposDeTabla instances
     * and return true if they contain same values in all persistent instance 
     * variables. If hasEqualMapping returns true, it does not mean the objects
     * are the same instance. However it does mean that in that moment, they 
     * are mapped to the same row in database.
     */
    public boolean hasEqualMapping(ViewCamposDeTabla valueObject) {
    ...
    public String toString() {
        ...
        out.append("\nclass ViewCamposDeTabla, mapping to table VIEW_CAMPOSDETABLA\n");
     ...
     */
    public Object clone() {
        ViewCamposDeTabla cloned = new ViewCamposDeTabla();
