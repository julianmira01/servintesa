...
/**
  * Diasfestivos Value Object.
  * This class is value object representing database table DIASFESTIVOS
...
public class Diasfestivos implements Cloneable, Serializable {
    ...
    /** 
     * hasEqualMapping-method will compare two Diasfestivos instances
     * and return true if they contain same values in all persistent instance 
     * variables. If hasEqualMapping returns true, it does not mean the objects
     * are the same instance. However it does mean that in that moment, they 
     * are mapped to the same row in database.
     */
    public boolean hasEqualMapping(Diasfestivos valueObject) {
    ...
    public String toString() {
        ...
        out.append("\nclass Diasfestivos, mapping to table DIASFESTIVOS\n");
     ...
     */
    public Object clone() {
        Diasfestivos cloned = new Diasfestivos();
