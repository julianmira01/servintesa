...
public class ConceptosTarifa implements Cloneable, Serializable {
    ...
    private String LT_IDTRAMITEINTERNO;
    ...
    public String getLT_IDTRAMITEINTERNO() {
          return this.LT_IDTRAMITEINTERNO;
    }
    public void setLT_IDTRAMITEINTERNO(String LT_IDTRAMITEINTERNOIn) {
          this.LT_IDTRAMITEINTERNO = LT_IDTRAMITEINTERNOIn;
    }
    ...
    public boolean hasEqualMapping(ConceptosTarifa valueObject) {
          ...
          if (this.LT_IDTRAMITEINTERNO == null) {
                    if (valueObject.getLT_IDTRAMITEINTERNO() != null)
                           return(false);
          } else if (!this.LT_IDTRAMITEINTERNO.equals(valueObject.getLT_IDTRAMITEINTERNO())) {
                    return(false);
          }
    ...
    public String toString() {
        ...
        out.append("LT_IDTRAMITEINTERNO = " + this.LT_IDTRAMITEINTERNO + "\n"); 
        return out.toString();
    }
    ...
    public Object clone() {
        ...
        if (this.LT_IDTRAMITEINTERNO != null)
             cloned.setLT_IDTRAMITEINTERNO(new String(this.LT_IDTRAMITEINTERNO)); 
        return cloned;
    }
