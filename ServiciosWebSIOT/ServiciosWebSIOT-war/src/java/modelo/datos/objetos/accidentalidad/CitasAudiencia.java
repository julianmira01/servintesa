...
public class CitasAudiencia implements Cloneable, Serializable {
    ...
    private int ID_MESAS_INSPECTORES;
    ...
    public CitasAudiencia () {

    }

    public CitasAudiencia (int ID_AREA_ACCIDENTEIn) {
     ...
     */
    public boolean hasEqualMapping(CitasAudiencia valueObject) {
     ...
     */
    public Object clone() {
        CitasAudiencia cloned = new CitasAudiencia();
    ...
    public int getID_ACCIDENTES() {
        return ID_ACCIDENTES;
    }

    public void setID_ACCIDENTES(int NOMBRE_TABLA) {
        this.ID_ACCIDENTES = NOMBRE_TABLA;
    }

    public int getID_MESAS_INSPECTORES() {
        return ID_MESAS_INSPECTORES;
    }

    public void setID_MESAS_INSPECTORES(int ID_MESAS_INSPECTORES) {
        this.ID_MESAS_INSPECTORES = ID_MESAS_INSPECTORES;
    }
    ...
    public void setID_IMPLICADO(int ID_IMPLICADO) {
        this.ID_IMPLICADO = ID_IMPLICADO;
    }
}
