...
public class FalloAudiencia implements Cloneable, Serializable {

    /** 
     * Persistent Instance variables. This data is directly 
     * mapped to the columns of database table.
     */
    private int ID_FALLO_AUDIENCIA;
    private String FECHA;
    private String HORA;
    private int ID_IMPLICADO;
    ...
    public FalloAudiencia () {

    }

    public FalloAudiencia (int ID_AREA_ACCIDENTEIn) {

          this.ID_FALLO_AUDIENCIA = ID_AREA_ACCIDENTEIn;
    ...
    public int getID_FALLO_AUDIENCIA() {
          return this.ID_FALLO_AUDIENCIA;
    }
    public void setID_FALLO_AUDIENCIA(int ID_AREA_ACCIDENTEIn) {
          this.ID_FALLO_AUDIENCIA = ID_AREA_ACCIDENTEIn;
    }
     ...
     */
    public boolean hasEqualMapping(FalloAudiencia valueObject) {

          if (valueObject.getID_FALLO_AUDIENCIA() != this.ID_FALLO_AUDIENCIA) {
                    return(false);
          }
          if (this.FECHA == null) {
    ...
    public String toString() {
        ...
        out.append("ID_AREA_ACCIDENTE = " + this.ID_FALLO_AUDIENCIA + "\n"); 
     ...
     */
    public Object clone() {
        FalloAudiencia cloned = new FalloAudiencia();

        cloned.setID_FALLO_AUDIENCIA(this.ID_FALLO_AUDIENCIA); 
        if (this.FECHA != null)
    ...
    public void setID_IMPLICADO(int NOMBRE_TABLA) {
        this.ID_IMPLICADO = NOMBRE_TABLA;
    }
    ...
    public void setFALLO(String DECLARACION) {
        this.FALLO = DECLARACION;
    }
