...
import java.math.*;
 ...
 /**
  * NuevaPersonaTrans Value Object.
  * This class is value object representing database table NuevaPersonaTrans
...
public class NuevaPersonaTrans implements Cloneable, Serializable {
    ...
    public NuevaPersonaTrans () {

    }

    public NuevaPersonaTrans (int IDIn) {
    ...
    /** 
     * hasEqualMapping-method will compare two NuevaPersonaTrans instances
     * and return true if they contain same values in all persistent instance 
     * variables. If hasEqualMapping returns true, it does not mean the objects
     * are the same instance. However it does mean that in that moment, they 
     * are mapped to the same row in database.
     */
    public boolean hasEqualMapping(NuevaPersonaTrans valueObject) {
    ...
    public String toString() {
        ...
        out.append("\nclass NuevaPersonaTrans, mapping to table NuevaPersonaTrans\n");
     ...
     */
    public Object clone() {
        NuevaPersonaTrans cloned = new NuevaPersonaTrans();
