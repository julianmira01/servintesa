...
import java.math.*;
 ...
 /**
  * ViewPropietarios Value Object.
  * This class is value object representing database table VIEW_PROPIETARIOS
...
public class ViewPropietarios implements Cloneable, Serializable {
    ...
    public void setID_PROPIETARIO(String ID_PROPIETARIOIn) {
    ...
    public void setID_DUENO(String ID_DUENOIn) {
    ...
    public void setAll(String ID_PROPIETARIOIn,
          String ID_DUENOIn,
    ...
    /** 
     * hasEqualMapping-method will compare two ViewPropietarios instances
     * and return true if they contain same values in all persistent instance 
     * variables. If hasEqualMapping returns true, it does not mean the objects
     * are the same instance. However it does mean that in that moment, they 
     * are mapped to the same row in database.
     */
    public boolean hasEqualMapping(ViewPropietarios valueObject) {

          if (this.ID_PROPIETARIO == null) {
                    if (valueObject.getID_PROPIETARIO() != null)
                           return(false);
          } else if (!this.ID_PROPIETARIO.equals(valueObject.getID_PROPIETARIO())) {
                    return(false);
          }
          if (this.ID_DUENO == null) {
                    if (valueObject.getID_DUENO() != null)
                           return(false);
          } else if (!this.ID_DUENO.equals(valueObject.getID_DUENO())) {
                    return(false);
          }
    ...
    public String toString() {
        ...
        out.append("\nclass ViewPropietarios, mapping to table VIEW_PROPIETARIOS\n");
     ...
     */
    public Object clone() {
        ViewPropietarios cloned = new ViewPropietarios();

        if (this.ID_PROPIETARIO != null)
             cloned.setID_PROPIETARIO(new String(this.ID_PROPIETARIO)); 
        if (this.ID_DUENO != null)
             cloned.setID_DUENO(new String(this.ID_DUENO)); 
        if (this.ID_VEHICULO != null)
