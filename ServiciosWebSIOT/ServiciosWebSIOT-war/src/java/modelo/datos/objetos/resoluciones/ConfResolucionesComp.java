...
import java.math.*;
 ...
 /**
  * ConfResolucionesComp Value Object.
  * This class is value object representing database table CONFRESOLUCIONES
...
public class ConfResolucionesComp implements Cloneable, Serializable {
    ...
    public ConfResolucionesComp () {

    }

    public ConfResolucionesComp (int IDIn) {
    ...
    /** 
     * hasEqualMapping-method will compare two ConfResolucionesComp instances
     * and return true if they contain same values in all persistent instance 
     * variables. If hasEqualMapping returns true, it does not mean the objects
     * are the same instance. However it does mean that in that moment, they 
     * are mapped to the same row in database.
     */
    public boolean hasEqualMapping(ConfResolucionesComp valueObject) {
    ...
    public String toString() {
        ...
        out.append("\nclass ConfResolucionesComp, mapping to table CONFRESOLUCIONES\n");
     ...
     */
    public Object clone() {
        ConfResolucionesComp cloned = new ConfResolucionesComp();
