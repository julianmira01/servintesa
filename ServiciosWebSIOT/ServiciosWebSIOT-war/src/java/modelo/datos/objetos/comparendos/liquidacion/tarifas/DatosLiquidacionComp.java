...
public class DatosLiquidacionComp implements Cloneable, Serializable {
    ...
    public DatosLiquidacionComp () {

    }

    public DatosLiquidacionComp (int IDITEMIn) {
     ...
     */
    public boolean hasEqualMapping(DatosLiquidacionComp valueObject) {
     ...
     */
    public Object clone() {
        DatosLiquidacionComp cloned = new DatosLiquidacionComp();
