...
import java.math.*;
 ...
 /**
  * ViewResFaltantesCarga Value Object.
  * This class is value object representing database table VIEW_RES_FALTANTES_CARGA
...
public class ViewResFaltantesCarga implements Cloneable, Serializable {
    ...
    public ViewResFaltantesCarga () {

    }

    public ViewResFaltantesCarga (String NUMEROIn) {
    ...
    /** 
     * hasEqualMapping-method will compare two ViewResFaltantesCarga instances
     * and return true if they contain same values in all persistent instance 
     * variables. If hasEqualMapping returns true, it does not mean the objects
     * are the same instance. However it does mean that in that moment, they 
     * are mapped to the same row in database.
     */
    public boolean hasEqualMapping(ViewResFaltantesCarga valueObject) {
    ...
    public String toString() {
        ...
        out.append("\nclass ViewResFaltantesCarga, mapping to table VIEW_RES_FALTANTES_CARGA\n");
     ...
     */
    public Object clone() {
        ViewResFaltantesCarga cloned = new ViewResFaltantesCarga();
