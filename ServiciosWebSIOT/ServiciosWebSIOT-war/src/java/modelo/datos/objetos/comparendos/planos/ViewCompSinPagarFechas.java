...
import java.math.*;
 ...
 /**
  * ViewCompSinPagarFechas Value Object.
  * This class is value object representing database table VIEW_COMPSINPAGAR_FECHAS
...
public class ViewCompSinPagarFechas implements Cloneable, Serializable {
    ...
    public ViewCompSinPagarFechas () {

    }

    public ViewCompSinPagarFechas (String PLACAIn) {
    ...
    /** 
     * hasEqualMapping-method will compare two ViewCompSinPagarFechas instances
     * and return true if they contain same values in all persistent instance 
     * variables. If hasEqualMapping returns true, it does not mean the objects
     * are the same instance. However it does mean that in that moment, they 
     * are mapped to the same row in database.
     */
    public boolean hasEqualMapping(ViewCompSinPagarFechas valueObject) {
    ...
    public String toString() {
        ...
        out.append("\nclass ViewCompSinPagarFechas, mapping to table VIEW_COMPSINPAGAR_FECHAS\n");
     ...
     */
    public Object clone() {
        ViewCompSinPagarFechas cloned = new ViewCompSinPagarFechas();
