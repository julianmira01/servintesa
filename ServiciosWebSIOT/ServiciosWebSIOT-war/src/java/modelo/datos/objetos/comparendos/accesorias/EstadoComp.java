...
import java.math.*;
 ...
 /**
  * EstadoComp Value Object.
  * This class is value object representing database table ESTADOCOM
...
public class EstadoComp implements Cloneable, Serializable {
    ...
    public EstadoComp (int ID_ESTADOIn) {
    ...
    /** 
     * hasEqualMapping-method will compare two EstadoComp instances
     * and return true if they contain same values in all persistent instance 
     * variables. If hasEqualMapping returns true, it does not mean the objects
     * are the same instance. However it does mean that in that moment, they 
     * are mapped to the same row in database.
     */
    public boolean hasEqualMapping(EstadoComp valueObject) {
    ...
    public String toString() {
        ...
        out.append("\nclass EstadoComp, mapping to table ESTADOCOM\n");
     ...
     */
    public Object clone() {
        EstadoComp cloned = new EstadoComp();
