...
public class ConceptosTarifa implements Cloneable, Serializable {
 ...
 // private List comparendos;
    ...
    public void setID_ITEM(String ID_ITEMIn) {
    ...
    public boolean hasEqualMapping(ConceptosTarifa valueObject) {
          ...
          if (this.ID_ITEM == null) {
                    if (valueObject.getID_ITEM() != null)
                           return(false);
          } else if (!this.ID_ITEM.equals(valueObject.getID_ITEM())) {
                    return(false);
          }
    ...
    public Object clone() {
        ...
        if (this.ID_ITEM != null)
             cloned.setID_ITEM(new String(this.ID_ITEM)); 
        if (this.DESCRIPCION != null)
 ...
 //   public void setComparendos(List comparendos) {
   //     this.comparendos = comparendos;
  //  }

   // public List getComparendos() {
      //  return comparendos;
    //}
}
