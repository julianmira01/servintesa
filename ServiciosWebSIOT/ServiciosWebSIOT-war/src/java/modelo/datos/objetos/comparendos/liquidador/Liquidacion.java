  ...
  public class Liquidacion implements Cloneable, Serializable {
    ...
    public void setID_CENTRO(int ID_CENTROin) {
      ...
      public Object clone() {
          ...
          if (this.NUMERO_CERTIFICADO != null)
               cloned.setNUMERO_CERTIFICADO(this.NUMERO_CERTIFICADO); 
          if (this.FECHA_CERTIFICADO != null)
               cloned.setFECHA_CERTIFICADO(new String(this.FECHA_CERTIFICADO)); 
          if (this.ID_CENTRO > 0)
               cloned.setID_CENTRO(this.ID_CENTRO); 
          if (this.NUMERO_CERTIFICADO != null)
              cloned.setNUMERO_CERTIFICADO(this.NUMERO_CERTIFICADO);
          if (this.FECHA_CERTIFICADO != null)
              cloned.setFECHA_CERTIFICADO(this.FECHA_CERTIFICADO);
          if (this.ID_CENTRO > 0)
              cloned.setID_CENTRO(this.ID_CENTRO);
          return cloned;
      }
