...
import java.math.*;
 ...
 /**
  * RangosDeComparendos Value Object.
  * This class is value object representing database table RANGOSDECOMPARENDOS
...
public class RangosDeComparendos implements Cloneable, Serializable {
    ...
    public RangosDeComparendos () {

    }

    public RangosDeComparendos (int ID_RANGOCOMPARENDOIn) {
    ...
    /** 
     * hasEqualMapping-method will compare two RangosDeComparendos instances
     * and return true if they contain same values in all persistent instance 
     * variables. If hasEqualMapping returns true, it does not mean the objects
     * are the same instance. However it does mean that in that moment, they 
     * are mapped to the same row in database.
     */
    public boolean hasEqualMapping(RangosDeComparendos valueObject) {
    ...
    public String toString() {
        ...
        out.append("\nclass RangosDeComparendos, mapping to table RANGOSDECOMPARENDOS\n");
     ...
     */
    public Object clone() {
        RangosDeComparendos cloned = new RangosDeComparendos();
