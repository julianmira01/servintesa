...
import java.math.*;
 ...
 /**
  * SalarioMinimoComp Value Object.
...
public class SalarioMinimoComp implements Cloneable, Serializable {
    ...
    public SalarioMinimoComp () {

    }

    public SalarioMinimoComp (int ANOIn) {
    ...
    /** 
     * hasEqualMapping-method will compare two SalarioMinimoComp instances
     * and return true if they contain same values in all persistent instance 
     * variables. If hasEqualMapping returns true, it does not mean the objects
     * are the same instance. However it does mean that in that moment, they 
     * are mapped to the same row in database.
     */
    public boolean hasEqualMapping(SalarioMinimoComp valueObject) {
    ...
    public String toString() {
        ...
        out.append("\nclass SalarioMinimoComp, mapping to table SALARIOMINIMO\n");
     ...
     */
    public Object clone() {
        SalarioMinimoComp cloned = new SalarioMinimoComp();
