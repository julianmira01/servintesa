...
public class CiudadComp implements Cloneable, Serializable {
    ...
    public CiudadComp (int ID_CIUDADIn) {
    ...
    /** 
     * hasEqualMapping-method will compare two CiudadComp instances
     * and return true if they contain same values in all persistent instance 
     * variables. If hasEqualMapping returns true, it does not mean the objects
     * are the same instance. However it does mean that in that moment, they 
     * are mapped to the same row in database.
     */
    public boolean hasEqualMapping(CiudadComp valueObject) {
    ...
    public String toString() {
        ...
        out.append("\nclass CiudadComp, mapping to table CIUDAD\n");
     ...
     */
    public Object clone() {
        CiudadComp cloned = new CiudadComp();
