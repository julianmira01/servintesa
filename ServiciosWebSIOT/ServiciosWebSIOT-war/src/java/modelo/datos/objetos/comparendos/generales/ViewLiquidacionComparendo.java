...
/**
  * ViewLiquidacionComparendo Value Object.
  * This class is value object representing database table VIEW_LIQUIDACION_COMPARENDO
...
public class ViewLiquidacionComparendo implements Cloneable, Serializable {
    ...
    public ViewLiquidacionComparendo() {

    }

    public ViewLiquidacionComparendo(int ID_COMPARENDOIn) {
    ...
    public void setAll(int ID_COMPARENDOIn, String NUMEROCOMPARENDOIn, int IDLIQUIDACIONIn) {
        this.ID_COMPARENDO = ID_COMPARENDOIn;
        this.NUMEROCOMPARENDO = NUMEROCOMPARENDOIn;
        this.IDLIQUIDACION = IDLIQUIDACIONIn;
    }
    ...
    /**
     * hasEqualMapping-method will compare two ViewLiquidacionComparendo instances
     * and return true if they contain same values in all persistent instance
     * variables. If hasEqualMapping returns true, it does not mean the objects
     * are the same instance. However it does mean that in that moment, they
     * are mapped to the same row in database.
     */
    public boolean hasEqualMapping(ViewLiquidacionComparendo valueObject) {
    ...
    public String toString() {
        ...
        out.append("\nclass ViewLiquidacionComparendo, mapping to table VIEW_LIQUIDACION_COMPARENDO\n");
     ...
     */
    public Object clone() {
        ViewLiquidacionComparendo cloned = new ViewLiquidacionComparendo();
