...
/**
  * ViewResolucionesAlcoholemia Value Object.
  * This class is value object representing database table VIEW_RESOLUCIONES_ALCOHOLEMIA
...
public class ViewResolucionesAlcoholemia implements Cloneable, Serializable {
    ...
    public ViewResolucionesAlcoholemia () {

    }

    public ViewResolucionesAlcoholemia (String NUMEROIn) {
    ...
    /** 
     * hasEqualMapping-method will compare two ViewResolucionesAlcoholemia instances
     * and return true if they contain same values in all persistent instance 
     * variables. If hasEqualMapping returns true, it does not mean the objects
     * are the same instance. However it does mean that in that moment, they 
     * are mapped to the same row in database.
     */
    public boolean hasEqualMapping(ViewResolucionesAlcoholemia valueObject) {
    ...
    public String toString() {
        ...
        out.append("\nclass ViewResolucionesAlcoholemia, mapping to table VIEW_RESOLUCIONES_ALCOHOLEMIA\n");
     ...
     */
    public Object clone() {
        ViewResolucionesAlcoholemia cloned = new ViewResolucionesAlcoholemia();
