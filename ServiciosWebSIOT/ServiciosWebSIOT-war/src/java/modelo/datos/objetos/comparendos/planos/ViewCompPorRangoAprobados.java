...
import java.math.*;
 ...
 /**
  * ViewCompPorRangoAprobados Value Object.
  * This class is value object representing database table VIEW_COMP_PORRANGO_APROBADOS
...
public class ViewCompPorRangoAprobados implements Cloneable, Serializable {
    ...
    public ViewCompPorRangoAprobados () {

    }

    public ViewCompPorRangoAprobados (String NROCOMPARENDOIn, int ID_RANGOCOMPARENDOSIn) {
    ...
    public void setAll(String NROCOMPARENDOIn,
    ...
    /** 
     * hasEqualMapping-method will compare two ViewCompPorRangoAprobados instances
     * and return true if they contain same values in all persistent instance 
     * variables. If hasEqualMapping returns true, it does not mean the objects
     * are the same instance. However it does mean that in that moment, they 
     * are mapped to the same row in database.
     */
    public boolean hasEqualMapping(ViewCompPorRangoAprobados valueObject) {
    ...
    public String toString() {
        ...
        out.append("\nclass ViewCompPorRangoAprobados, mapping to table VIEW_COMP_PORRANGO_APROBADOS\n");
     ...
     */
    public Object clone() {
        ViewCompPorRangoAprobados cloned = new ViewCompPorRangoAprobados();
