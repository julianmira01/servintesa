...
/**
  * ViewResSinAlcoholemia Value Object.
  * This class is value object representing database table VIEW_RES_SINALCOHOLEMIA
...
public class ViewResSinAlcoholemia implements Cloneable, Serializable {
    ...
    public ViewResSinAlcoholemia () {

    }

    public ViewResSinAlcoholemia (String NUMEROIn) {
    ...
    /** 
     * hasEqualMapping-method will compare two ViewResSinAlcoholemia instances
     * and return true if they contain same values in all persistent instance 
     * variables. If hasEqualMapping returns true, it does not mean the objects
     * are the same instance. However it does mean that in that moment, they 
     * are mapped to the same row in database.
     */
    public boolean hasEqualMapping(ViewResSinAlcoholemia valueObject) {
    ...
    public String toString() {
        ...
        out.append("\nclass ViewResSinAlcoholemia, mapping to table VIEW_RES_SINALCOHOLEMIA\n");
     ...
     */
    public Object clone() {
        ViewResSinAlcoholemia cloned = new ViewResSinAlcoholemia();
