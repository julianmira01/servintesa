...
import java.math.*;
 ...
 /**
  * ViewCompFaltantesCarga Value Object.
  * This class is value object representing database table VIEW_COMP_FALTANTES_CARGA
...
public class ViewCompFaltantesCarga implements Cloneable, Serializable {
    ...
    public ViewCompFaltantesCarga () {

    }

    public ViewCompFaltantesCarga (String PLACAIn) {
    ...
    /** 
     * hasEqualMapping-method will compare two ViewCompFaltantesCarga instances
     * and return true if they contain same values in all persistent instance 
     * variables. If hasEqualMapping returns true, it does not mean the objects
     * are the same instance. However it does mean that in that moment, they 
     * are mapped to the same row in database.
     */
    public boolean hasEqualMapping(ViewCompFaltantesCarga valueObject) {
    ...
    public String toString() {
        ...
        out.append("\nclass ViewCompFaltantesCarga, mapping to table VIEW_COMP_FALTANTES_CARGA\n");
     ...
     */
    public Object clone() {
        ViewCompFaltantesCarga cloned = new ViewCompFaltantesCarga();
