...
import modelo.logica.comparendos.centros_atencion.GestionCentroatencion;

import utilidades.Funciones;
import utilidades.Seguridad;

@WebService
public class ServiciosAccesoriasComp {
    ...
    GestionCentroatencion gestionCentroatencion;
    
    public ServiciosAccesoriasComp() {
        super();
        ...
        gestionCentroatencion = new GestionCentroatencion();
    }
    ...
    @WebMethod
    public List getTiposInfraccionesComp()
    {
        return gestionServiciosAccesorias.getTiposInfraccionComp();
    }
   ...
   public List searchEstadosComp(EstadoComp estadoComp){
    ...
    public String getFechaHora(String formato){
        return Funciones.getFechaSistema2(formato,null);
            ...
            @WebMethod
            public Centroatencion crearCentroatencion(int id, String token, Centroatencion obj ) {
                                    return gestionCentroatencion.crearCentroatencion(obj); 
            }
            
            @WebMethod
            public boolean editarCentroatencion(int id, String token,Centroatencion obj) {
                                    return gestionCentroatencion.editarCentroatencion(obj);
            }
            
            @WebMethod
            public Centroatencion buscarPrimeroCentroatencion(int id, String token,Centroatencion obj) {
                                    return gestionCentroatencion.buscarPrimeroCentroatencion(obj);
            }
            
            @WebMethod
            public List buscarCentroatencion(int id, String token,Centroatencion obj) {
                                    return gestionCentroatencion.buscarCentroatencion(obj);
            }
            
            @WebMethod
            public List buscarPaginacionCentroatencion(int id, String token,Centroatencion obj,int pag,int numReg) {
                                    return gestionCentroatencion.buscarCentroatencion(obj, pag, numReg);
            }
            
            @WebMethod
            public List listarCentroatencion(int id, String token) {
                            return gestionCentroatencion.listarCentroatencion();
            }
            
            @WebMethod
            public List listarPaginacionCentroatencion(int id, String token,int pag,int numReg) {
                            return gestionCentroatencion.listarCentroatencion(pag, numReg);
            }
            
            @WebMethod
            public int contarBusquedaCentroatencion(int id, String token,Centroatencion obj) {
                                    return gestionCentroatencion.contarBusquedaCentroatencion(obj);
            }
            
            @WebMethod
            public boolean eliminarCentroatencion(int id, String token,Centroatencion obj) {
                                    return gestionCentroatencion.eliminarCentroatencion(obj);
            }
}
